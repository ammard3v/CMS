...
Partial Class Reset
    ...
    Private Sub InitializeComponent()
        ...
        Panel2.Controls.Add(txtSecuritycode)
        ...
        btnBack.Location = New Point(358, 333)
        ...
        Label3.Location = New Point(75, 155)
        Label3.Name = "Label3"
        ...
        txtSecuritycode.Location = New Point(217, 149)
        txtSecuritycode.Name = "txtSecuritycode"
        txtSecuritycode.Size = New Size(235, 34)
        txtSecuritycode.TabIndex = 5
        ' 
        ' btnReset
        ' 
        ...
        btnReset.Location = New Point(217, 333)
        ...
        Label1.Location = New Point(89, 208)
        Label1.Name = "Label1"
        ...
        txtPassword.Location = New Point(217, 274)
        ...
        txtUsername.Location = New Point(217, 212)
        ...
        Label4.Location = New Point(11, 342)
        Label4.Name = "Label4"
        Label4.Size = New Size(312, 31)
        Label4.TabIndex = 3
        Label4.Text = "CollegeManagementSystem"
        ' 
        ' PictureBox1
        ' 
